  ...
  <div class="cards">
    <div class="container">
      ...
      <div class="wrapper">
        ...
        <div @click="moreCard" class="area__btn">
...
export default {
  ...
  methods:{
    addToCart(product_data){
      this.$emit('addToCart', product_data);
    },
    moreCard(){
      this.cards__products.push(this.PRODUCTS.slice(this.countCards, this.countCards+4))
      this.countCards+=4
    }
  },
  computed: {
    sortedCard(){
      return this.cards__products = this.PRODUCTS.slice(0, this.countCards)
    }
  }
}
</script>
